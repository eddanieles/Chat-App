...
(0, _jquery2.default)(function () {
  ...
  (0, _jquery2.default)(".messages").hide();

  var username_text;

  (0, _jquery2.default)(".login").on("submit", function (e) {
    (0, _jquery2.default)(".messages").show();
    username_text = (0, _jquery2.default)("#username").val();
    e.preventDefault();
  });

  var $messages_list = (0, _jquery2.default)("#messages_list");
  ...
  _jquery2.default.ajax({
    ...
    success: function success(response) {
      _jquery2.default.each(response.data, function (i, item) {
        addMessage(item);
      });
    },
  ...
  (0, _jquery2.default)("#messages_list").on("click", ".remove", function (event) {
